...
class TicketController extends Controller
{
    ...
    public function create()
    {
        ...
        public function edit(Ticket $ticket, Request $request)
        {
            ...
            return view('dashboard.tickets.edit', compact('ticket', 'machines', 'technicians', 'customers', 'articles'));
        }
        ...
        public function update(Request $request, $id)
        {
            ...
            // $request->validate([
                ...
                return redirect()->route('dashboard.tickets.edit', $ticket->id)->with('success', 'Ticket aggiornato con successo!');
            }
