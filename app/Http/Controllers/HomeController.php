...
class HomeController extends Controller
{
    public function index()
    {
        ...
        // Calcolo del numero di scadenze in scadenza (entro 60 giorni dalla data odierna)
        ...
        // Calcolo del numero di documenti in flotta in scadenza (entro 60 giorni dalla data odierna)
        ...
        return view('dashboard.dashboard',  compact(
            'openTicketsCount', 
            'waitingForSparePartsCount', 
            'urgentTicketsCount', 
            'expiringDeadlinesCount', 
        ...
        public function indexHome()
        {
            ...
            return view('dashboard.dashboard',  compact('openTicketsCount',
            'waitingForSparePartsCount', 
            'urgentTicketsCount', 
            'expiringDeadlinesCount', 
            'expiredDeadlinesCount', 
