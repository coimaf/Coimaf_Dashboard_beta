        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 rounded-3 mt-5" style="background-color: rgb(243, 243, 243); height: 90vh;">
                <div class="col-12 rounded-2 mt-3 p-5 container-create" style="max-height: 80vh; overflow-y: scroll">
                    <h2 class="">Modifica Macchina</h2>

                    <form action="{{ route('dashboard.machinesSolds.update', $machine->id) }}" method="POST" class="my-5" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6 mb-4">
                                ...
                                <input type="date" name="warranty_expiration_date" class="form-control" value="{{ old('warranty_expiration_date', $machine->warranty_expiration_date) }}" required>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mb-4">
                                ...
                                <input type="date" name="registration_date" class="form-control" value="{{ old('registration_date', $machine->registration_date) }}" required>
                            </div>
